...
namespace Worldpay.Sdk
{
    ...
    public class OrderService : AbstractService
    {
        ...
        public TransferOrder FindOrder(string orderCode)
        {
            ...
            return Http.Get<TransferOrder>($"{_baseUrl}/orders/{orderCode}");
        }
        ...
        public OrderResponse CaptureAuthorizedOrder(string orderCode)
        {
            ...
            return Http.Post<CaptureRequest, OrderResponse>($"{_baseUrl}/orders/{orderCode}/capture", null);
        }
        ...
        public OrderResponse CaptureAuthorizedOrder(string orderCode, int amount)
        {
            ...
            else
            {
                ...
                return Http.Post<CaptureRequest, OrderResponse>($"{_baseUrl}/orders/{orderCode}/capture", new CaptureRequest { captureAmount = amount });
            }
        }
        ...
        public void CancelAuthorizedOrder(string orderCode)
        {
            ...
            Http.Delete($"{_baseUrl}/orders/{orderCode}");
        }
        ...
        public OrderResponse Authorize(string orderCode, string responseCode, ThreeDSecureInfo threeDSInfo)
        {
            ...
            return Http.Put<OrderAuthorizationRequest, OrderResponse>($"{_baseUrl}/orders/{orderCode}",
        ...
        public void Refund(String orderCode)
        {
            ...
            Http.Post($"{_baseUrl}/orders/{orderCode}/refund", null);
        }
        ...
        public void Refund(String orderCode, int amount)
        {
            ...
            else
            {
                ...
                Http.Post($"{_baseUrl}/orders/{orderCode}/refund", partialRefundRequest);
            }
        }
    }
}
