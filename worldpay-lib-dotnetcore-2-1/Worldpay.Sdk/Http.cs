...
namespace Worldpay.Sdk
{
    ...
    public class Http
    {
        ...
        public TO HandleRequest<TO>(HttpRequest request)
        {
            ...
            return HandleResponse<TO>(request.Body);
        }
        ...
        private HttpWebRequest CreateRequest(string api, RequestMethod method, object data, bool authorize)
        {
            ...
            //request.Headers.Add("x-wp-client-user-agent", "NET-Client-4_6");
            request.Headers.Add("x-wp-client-user-agent", "NET-Core-2_1");
            ...
            switch (method)
            {
                ...
                default:
                    ...
                    throw new NotSupportedException($"Request method {method.ToString()} not supported");
            }
